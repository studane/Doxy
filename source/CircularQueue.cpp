 ...
 * @date 2026-06-08
 * 
 * @copyright zhidane.prabowo.ft25@mail.umy.ac.id (c) 2026*
 * 
 */
#include <iostream>
using namespace std;
...
private:
    ...
    int max = 5; ///< variable private untuk menyimpan ukuran maximum antrian
...
public:
    ...
    /**
     * @brief method untuk mmasukkan data dalam antrian
 ...
 */
int main() {
    Queues q;///< obbjek untuk menggunakan member yang ada pada class queues
